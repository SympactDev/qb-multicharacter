...
loadingIcon = function(tiempo) {
    ...
    var originalText = "Informatie Overheid aan het ophalen";
    ...
    var DotsInterval = setInterval(function() {
        ...
        if (loadingProgress == 3) {
            originalText = "Koekje aan het eten..."
            $("#loading-text").html(originalText);
        }
        if (loadingProgress == 4) {
            originalText = "Olivier is heel schattig"
            $("#loading-text").html(originalText);
        }
        if (loadingProgress == 6) {
            originalText = "Ik hou van mannen"
            $("#loading-text").html(originalText);
        }
        if(loadingDots == 4) {
            $("#loading-text").html(originalText);
    ...
    setTimeout(function(){
        ...
        loadingProgress = 0;
        originalText = "Informatie Overheid aan het ophalen";
    }, tiempo);//2000);
}
...
function setupCharInfo(cData) {
    if (cData == 'empty') {
        ...
        '<div class="character-info-box"><span id="info-label">Volledige Naam: </span><span class="char-info-js">'+cData.charinfo.firstname+' '+cData.charinfo.lastname+'</span></div>' +
        '<div class="character-info-box"><span id="info-label">Geboorte: </span><span class="char-info-js">'+cData.charinfo.birthdate+'</span></div>' +
        ...
        '<div class="character-info-box"><span id="info-label">Geld op zak: </span><span class="char-info-js">$ '+cData.money.cash+'</span></div>' +
        '<div class="character-info-box"><span id="info-label">Geld op bank: </span><span class="char-info-js">$ '+cData.money.bank+'</span></div><br>' +
        ...
        '<div class="character-info-box"><span id="info-label">IBAN: </span><span class="char-info-js">'+cData.charinfo.account+'</span></div></div>');
        $('.char-info').tooltip();
    }
}
